---
name: ux-dashboard
description: Use this skill for dashboards, analytics products, reporting interfaces, tables, charts, filters, alerts, and decision-support UX.
---
...
Make complex data interfaces clearer, more trustworthy, more actionable, and easier to use for real decisions.

## When to Use This Skill

- The user asks about dashboards, reports, tables, metrics, charts, analytics, admin panels, monitoring, or decision-support interfaces.
- The product includes dense data, filters, comparisons, status states, alerts, or export/reporting workflows.
- Users need to interpret information and decide what to do next.

## Inputs

- Screenshots, prototype, dashboard URL, data model, user roles, metrics, tables, filters, reports, chart examples, task goals, analytics requirements.
...
- **ux-dashboard:** owns data UX, charts, tables, metrics, reporting, alerts, and decision support.
- **ux-enterprise:** owns power-user workflows, roles, permissions, bulk actions, and operational complexity.
- **ux-information-architect:** owns data structure, grouping, navigation, and findability.
- **ux-analytics:** owns metric definitions, instrumentation logic, and data interpretation risk.
- **ux-accessibility:** owns chart/table accessibility, keyboard use, contrast, semantics, and alternatives.

## Supporting Agents

Consult these agents when their domain appears in the work:

- **ux-content-strategist:** reviews metric labels, helper text, empty states, and explanations.
- **ux-design-systems:** reviews reusable table, filter, chart, and state components.
...
1. Define user role, decision context, and primary questions the dashboard must answer.
2. Inventory metrics, data objects, controls, filters, states, and outputs.
3. Evaluate hierarchy, scanability, comparison, filtering, table behavior, chart choice, status clarity, and actionability.
4. Identify data trust risks: unclear definitions, stale data, missing context, misleading visualization, or poor empty states.
5. Recommend layout, component, labeling, filtering, and accessibility improvements.
6. Define measurement and validation through task tests and usage analytics.
...
## User Questions and Decision Context

## Data UX Findings

## Table / Chart / Filter Recommendations

## Accessibility and State Recommendations
...
- Do not add more charts when the problem is decision clarity.
- Do not treat all metrics as equally important.
- Do not ignore empty, loading, error, stale, or permission states.
- Do not use visualizations that obscure comparison or action.
