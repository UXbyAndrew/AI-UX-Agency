---
name: ux-ia
description: Use this skill for navigation, taxonomy, labeling, content structure, search, filtering, hierarchy, and findability analysis.
---

# UX Information Architecture Skill

## Mission

Make information, navigation, and product structure easier to understand, predict, scan, and use.

## When to Use This Skill

- The user asks about navigation, sitemap, menu structure, labeling, taxonomy, search, filtering, page hierarchy, or content organization.
- Users may struggle to find information, choose a path, or understand where they are.
- A site or product has complex content, categories, dashboards, settings, commerce, or enterprise workflows.

## Inputs

- URL, sitemap, navigation, page list, content inventory, screenshots, product structure, categories, search/filter examples, user tasks.
...
- **ux-information-architect:** owns navigation, taxonomy, hierarchy, labeling, wayfinding, and findability.
- **ux-content-strategist:** owns label clarity, content hierarchy, and comprehension.
- **ux-heuristics:** reviews usability implications and task friction.

## Supporting Agents

Consult these agents when their domain appears in the work:

- **ux-researcher:** recommends card sort, tree test, or findability research.
- **ux-analytics:** identifies search logs, navigation behavior, and content performance signals.
- **ux-enterprise:** supports role-based IA complexity.
...
1. Define primary user tasks and findability goals.
2. Inventory current structure, labels, navigation, categories, and content hierarchy.
3. Identify mismatches between user mental models and system structure.
4. Evaluate wayfinding, search, filters, breadcrumbs, cross-links, and progressive disclosure.
5. Recommend IA changes with rationale, risk, and validation.
6. Propose research methods when structure is uncertain.
...
## Labeling and Navigation Recommendations

## Proposed Structure / Taxonomy
...
- Do not reorganize based only on internal company structure.
- Do not create clever labels at the expense of clarity.
- Do not recommend IA changes without considering migration, content ownership, and validation.
